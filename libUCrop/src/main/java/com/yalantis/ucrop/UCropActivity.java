...
public class UCropActivity extends AppCompatActivity {
    ...
    private void processOptions(@NonNull Intent intent) {
        ...
        mOverlayView.setNeedUpDownCorner(intent.getBooleanExtra(UCrop.Options.EXTRA_SHOW_CROP_UP_DOWN, false));
        ...
        mOverlayView.setShowChangingSize(intent.getBooleanExtra(UCrop.Options.EXTRA_SHOW_CHANGING_SIZE, false));
