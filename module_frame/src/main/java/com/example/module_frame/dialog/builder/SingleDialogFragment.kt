...
import com.example.module_frame.databinding.FragmentDialogSingleBinding
import com.example.module_frame.extend.dip

class SingleDialogFragment : DialogFragment() {
    private var dialogBinding: FragmentDialogSingleBinding? = null
    ...
    companion object {
        fun newInstance(): SingleDialogFragment {
    ...
    override fun onCreateView(
        ...
        dialogBinding = FragmentDialogSingleBinding.inflate(inflater, container, false)
        return binding.root
    }
